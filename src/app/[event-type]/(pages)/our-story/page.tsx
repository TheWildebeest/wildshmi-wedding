...
const OurStoryPage: FC = () => {
  ...
  return (
    <div className="max-w-[50em] mx-auto">
      ...
      <Paragraph>
        Unfortunately, Lakshmi and David are <i>not</i> superheroes, regardless
        of how they may privately view themselves and/or each other.
      </Paragraph>
      <Paragraph>
        Take it from someone who knows them pretty darn well — they&lsquo;re
        just a couple of regular folk.
      </Paragraph>
      <Paragraph>
        Notwithstanding their underwhelming averageness, if you&lsquo;re not
        equally well acquainted with both Lakshmi and David, there are probably
      ...
      <Paragraph>
        ...
        traditional representation of Lakshmi — flush with cash, and remarkably
        zen about it.
      </Paragraph>
      <AccessibleImage
        image={goddessLakshmi}
        altText="Goddess Lakshmi sitting on a lotus"
        captionText="Goddess Lakshmi, flaunting her gold bling"
      />
      <Paragraph>
      ...
      <AccessibleImage
        image={blingshmi}
        altText="Lakshmi casually trying on jewelry"
        captionText="An actual Lakshmi with actual gold bling"
      />
      <AccessibleImage
        image={beautyshmi}
        altText="Lakshmi wearing gold jewelry on her engagement day"
        captionText="Looking incredible on her engagement day"
      />
      <Paragraph>
      ...
      <AccessibleImage
        image={laughshmi}
        altText="Lakshmi laughing at her boyfriend&lsquo;s jokes"
      ...
      <AccessibleImage
        image={kingdavid}
        altText="King David playing the harp"
        captionText="Biblical David was known to play the harp"
      />
      <Paragraph>
      ...
      <AccessibleImage
        image={violindavid}
        altText="David playing violin"
        captionText="David... that&lsquo;s not even a guitar"
      />
      ...
      <AccessibleImage
        image={codingdavid}
        altText="David reading a magazine with Lakshmi sleeping next to him"
        captionText="Some bedtime reading"
      />
      <Text tagName="h2" size="L">
        👩🏾‍❤️‍👨🏼 How they met
      </Text>
      ...
      <AccessibleImage
        image={threetuns}
        altText="David and Lakshmi at the pub"
        captionText="Visiting those fateful halogens again two years later"
      />
      ...
      <AccessibleImage
        image={exhausted}
        altText="Lakshmi comforts David"
        captionText="After a long day of debacles with easyJet, Lakshmi was a sight for sore eyes"
      />
      <Paragraph>
      ...
      <AccessibleImage
        image={covidcuties}
        altText="Lakshmi and David"
        captionText="Sun&lsquo;s out masks off"
      />
      <Paragraph>
      ...
      <AccessibleImage
        image={folks}
        altText="Lakshmi and David and their parents"
        captionText="Introducing the in-laws to the Full English"
      />
      ...
      <AccessibleImage
        image={proposal}
        altText="David proposing to Lakshmi"
        captionText="♫ He liked it so he put a ring on it ♪"
      />
      <Paragraph>
      ...
      <AccessibleImage
        image={surpriseparty}
        altText="A surprise party"
        captionText="Totally got her! She had no idea!"
      />
      <Paragraph>
      ...
      <AccessibleImage
        image={ceremony}
        altText="Both families together at the engagement ceremony"
        captionText="Both families together at the engagement ceremony"
      />
      <Paragraph>
        You can check out the photos from the proposal and the engagement party
        on the{" "}
        <Link href={{ pathname: basePath + "/photos" }}>photos page</Link>.
      </Paragraph>
      <Paragraph>
      ...
      <AccessibleImage
        image={keralacuties}
        altText="Sunset in Kerala"
        captionText="The view from Lakshmi&lsquo;s rooftop in Kerala"
      />
